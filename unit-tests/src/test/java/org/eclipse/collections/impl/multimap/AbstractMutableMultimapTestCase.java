...
public abstract class AbstractMutableMultimapTestCase extends AbstractMultimapTestCase
{
    ...
    public void getIfAbsentPut()
    {
        ...
        Assert.assertEquals(this.createCollection(), multimap.getIfAbsentPut(1, Lists.mutable.with()));
        Assert.assertFalse(multimap.containsKey(1));
        Assert.assertEquals(0, multimap.size());

        Assert.assertEquals(this.createCollection(1), multimap.getIfAbsentPut(1, Lists.mutable.with(1)));
        Verify.assertThrows(UnsupportedOperationException.class, () -> multimap.getIfAbsentPut(1, Lists.mutable.with(1)).add(1));

        multimap.putAll(2, Lists.mutable.with(2, 2));
        multimap.putAll(3, Lists.mutable.with(3, 3, 3));
        Assert.assertEquals(this.createCollection(1), multimap.getIfAbsentPut(1, Lists.mutable.empty()));
        Assert.assertEquals(this.createCollection(2, 2), multimap.getIfAbsentPut(2, Lists.mutable.empty()));
        Assert.assertEquals(this.createCollection(3, 3, 3), multimap.getIfAbsentPut(3, Lists.mutable.empty()));
        Assert.assertEquals(this.createCollection(4, 4, 4, 4), multimap.getIfAbsentPut(4, Lists.mutable.with(4, 4, 4, 4)));
        ...
        Verify.assertThrows(UnsupportedOperationException.class, () -> multimap.getIfAbsentPut(5, Lists.mutable.with(5)).add(5));
    }
